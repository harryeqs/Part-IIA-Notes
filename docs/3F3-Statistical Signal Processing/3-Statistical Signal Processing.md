...
![linear-system-correlations](assets/Statistical-Signal-Processing/linear-system-correlations.png){width=50%}
</figure>
...
<figure markdown="span">
![wiener-filtering-problem](assets/Statistical-Signal-Processing/wiener-filtering-problem.png){width=50%}
</figure>
...
<figure markdown="span">
![wiener-filter](assets/Statistical-Signal-Processing/wiener-filter.png){width=50%}
</figure>
